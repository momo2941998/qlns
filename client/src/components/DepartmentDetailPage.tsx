...
const DepartmentDetailPage = () => {
  ...
  const handleDeleteOne = async (employeeId: string, name: string) => {
  ...
  const toggleColumn = (columnKey: string) => {
    setVisibleColumns((prev) => {
      ...
      localStorage.setItem(`dept-page-${id}-columns`, JSON.stringify(newColumns));
      return newColumns;
    });
  };
  ...
  const resetColumns = () => {
    ...
    localStorage.setItem(`dept-page-${id}-columns`, JSON.stringify(defaultVisibleColumns));
  };
  ...
  if (!department) {
    return (
      <div className="section">
        <div className="error">Không tìm thấy phòng ban</div>
        ...
        <div className="department-info-card">
          ...
          <div className="info-grid">
            <div className="info-item">
              ...
              <span className="value">{department.stt}</span>
            </div>
            <div className="info-item">
              <span className="label">Tên:</span>
              <span className="value">{department.ten}</span>
            </div>
            <div className="info-item">
              <span className="label">Số nhân viên:</span>
              <span className="value">{departmentEmployees.length}</span>
            </div>
          </div>
        </div>
